...
$phpAds_nav = array (
	"admin"	=> array (
		"2"						=>  array("stats-global-client.php" => $strStats),
		    ...
		    "2.1.2"				=> 	array("stats-campaign-banners.php?clientid=$clientid&campaignid=$campaignid" => $strBannerOverview),
    	      "2.1.2.1" 		=> 	array("stats-banner-history.php?clientid=$clientid&campaignid=$campaignid&bannerid=$bannerid" => $strBannerHistory),
		        "2.1.2.1.1" 	=> 	array("stats-banner-daily.php?clientid=$clientid&campaignid=$campaignid&bannerid=$bannerid&day=$day" => $strDailyStats),
		        "2.1.2.1.2" 	=> 	array("stats-banner-daily-hosts.php?clientid=$clientid&campaignid=$campaignid&bannerid=$bannerid&day=$day" => $strHosts),
    	      "2.1.2.2" 		=> 	array("stats-banner-affiliates.php?clientid=$clientid&campaignid=$campaignid&bannerid=$bannerid" => $strDistribution),
		    "2.1.3"		 		=> 	array("stats-campaign-history.php?clientid=$clientid&campaignid=$campaignid" => $strCampaignHistory),
		...
		"4"						=>	array("client-index.php" => $strAdminstration),
		  "4.1"					=>	array("client-index.php" => $strClientsAndCampaigns),
		    ...
		    "4.1.3"				=> 	array("client-campaigns.php?clientid=$clientid" => $strCampaignOverview),
		      "4.1.3.1"			=>  array("campaign-edit.php?clientid=$clientid&campaignid=0" => $strAddCampaign),
		      ...
		      "4.1.3.4"			=> 	array("campaign-index.php?clientid=$clientid&campaignid=$campaignid" => $strBannerOverview),
		        "4.1.3.4.1"		=> 	array("banner-edit.php?clientid=$clientid&campaignid=$campaignid&bannerid=0" => $strAddBanner),
		  ...
		  "4.2" 				=> 	array("affiliate-index.php" => $strAffiliatesAndZones),
		    "4.2.1" 			=> 	array("affiliate-edit.php?affiliateid=0" => $strAddNewAffiliate),
		    ...
		    "4.2.3" 			=> 	array("zone-index.php?affiliateid=$affiliateid" => $strZoneOverview),
		      "4.2.3.1"			=> 	array("zone-edit.php?affiliateid=$affiliateid&zoneid=0" => $strAddNewZone),
	...
	"client" => array (
		"1"						=>  array("index.php" => $strHome),
		  "1.1"					=>  array("index.php" => $strOverview),
		    "1.1.1"				=> 	array("stats-campaign-banners.php?clientid=$clientid&campaignid=$campaignid" => $strCampaignStats),
		  	  "1.1.1.1"			=> 	array("stats-banner-history.php?clientid=$clientid&campaignid=$campaignid&bannerid=$bannerid" => $strBannerHistory),
		        "1.1.1.1.1"		=> 	array("stats-banner-daily.php?clientid=$clientid&campaignid=$campaignid&bannerid=$bannerid&day=$day" => $strDailyStats),
		        "1.1.1.1.2"		=> 	array("stats-banner-daily-hosts.php?clientid=$clientid&campaignid=$campaignid&bannerid=$bannerid&day=$day" => 'Hosts'),
		      "1.1.1.2"			=> 	array("banner-edit.php?clientid=$clientid&campaignid=$campaignid&bannerid=$bannerid" => $strModifyBanner),
			  "1.1.1.3"			=>  array("banner-swf.php?clientid=$clientid&campaignid=$campaignid&bannerid=$bannerid" => 'Convert Flash links'),
		    "1.1.2"				=> 	array("stats-campaign-history.php?clientid=$clientid&campaignid=$campaignid" => $strCampaignHistory),
