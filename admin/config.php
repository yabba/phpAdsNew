...
$phpAds_nav = array (
	"admin"	=> array (
		"2"					=>  array("stats-index.php" => $strStats),
		    ...
		    "2.1.1"			=>  array("stats-client.php?clientid=$clientid" => $strClientHistory),
		    "2.1.2"			=> 	array("stats-campaign.php?campaignid=$campaignid" => $strCampaignOverview),
    	      "2.1.2.1" 	=> 	array("stats-details.php?campaignid=$campaignid&bannerid=$bannerid" => $strBannerHistory),
		  ...
		  "2.2"				=>  array("stats-history.php" => $strGlobalHistory),
	      "2.3"		 		=> 	array("stats-weekly.php?campaignid=0" => $strWeeklyStats),
	      "2.4"		 		=> 	array("stats-affiliates.php" => $strAffiliatesAndZones),
		    "2.4.1"			=>  array("stats-affiliate-zones.php?affiliateid=$affiliateid" => $strAffiliateOverview),
		      "2.4.1.1"		=>  array("stats-zone-history.php?affiliateid=$affiliateid&zoneid=$zoneid" => $strZoneHistory),
		        "2.4.1.1.1"	=>  array("stats-zone-banner.php?affiliateid=$affiliateid&zoneid=$zoneid&bannerid=$bannerid" => $strLinkedBannerHistory),
		    "2.4.2"			=>  array("stats-affiliate-history.php?affiliateid=$affiliateid" => $strAffiliateHistory),
