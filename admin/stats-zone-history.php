...
echo "<td height='35' colspan='1' align='left'>";
	echo "&nbsp;".$strDays.":&nbsp;";
	echo "<a href='stats-zone-history.php?affiliateid=".$affiliateid."&zoneid=".$zoneid."&start=".$start."&limit=7'>7</a>&nbsp;|&nbsp;";
	echo "<a href='stats-zone-history.php?affiliateid=".$affiliateid."&zoneid=".$zoneid."&start=".$start."&limit=14'>14</a>&nbsp;|&nbsp;";
	echo "<a href='stats-zone-history.php?affiliateid=".$affiliateid."&zoneid=".$zoneid."&start=".$start."&limit=21'>21</a>&nbsp;|&nbsp;";
	echo "<a href='stats-zone-history.php?affiliateid=".$affiliateid."&zoneid=".$zoneid."&start=".$start."&limit=28'>28</a>";
echo "</td>";
echo "<td height='35' colspan='3' align='right'>";
	if ($start > 0)
	{
		echo "<a href='stats-zone-history.php?affiliateid=".$affiliateid."&zoneid=".$zoneid."&limit=".$limit."&start=".$previous."'>";
	...
	if ($span > ($start + $limit))
	{
		...
		echo "<a href='stats-zone-history.php?affiliateid=".$affiliateid."&zoneid=".$zoneid."&limit=".$limit."&start=".$next."'>";
