...
if (phpAds_isUser(phpAds_Admin))
{
	...
	while ($row = phpAds_dbFetchArray($res))
	{
		...
		$extra .= "<a href=stats-zone-banner.php?affiliateid=".$affiliateid."&zoneid=".$zoneid."&bannerid=".$row['bannerid'].">".phpAds_getBannerName ($row['bannerid'])."</a>";
		$extra .= "<br>"; 
	}
	$extra .= "<img src='images/break.gif' height='1' width='160' vspace='4'><br>";
	
	
	phpAds_PageHeader("2.4.1.1.1", $extra);
		...
		phpAds_ShowSections(array("2.4.1.1.1"));
}
else
{
...
echo "<tr>";
echo "<form action='stats-zone-banner.php'>";
