...
function phpAds_placeLayerSettings ()
{
	...
	echo "<td width='200'>".'Smooth movement'."</td><td width='370'>";
	echo "<select name='trail' style='width:60px;' onChange='this.form.stickyness.disabled = this.selectedIndex ? true : false;'>";
	...
	echo "<select name='stickyness' style='width:60px;'".($trail == '0' ? ' disabled' : '').">";
	for ($i=1;$i<=9;$i++)
	...
	echo "<tr><td width='30'>&nbsp;</td>";
	echo "<td width='200'>".'Hide the banner when the cursor is not moving'."</td><td width='370'>";
	echo "<select name='hide' style='width:60px;' onChange='this.form.transparancy.disabled = this.selectedIndex ? true : false; this.form.delay.disabled = this.selectedIndex ? true : false;'>";
	...
	echo "<tr><td width='30'>&nbsp;</td>";
	echo "<td width='200'>".'Delay before banner is hidden'."</td><td width='370'>";
		echo "<input class='flat' type='text' name='delay' size='' value='".$delay."' style='width:60px;'".($hide == '0' ? ' disabled' : '')."> ms</td></tr>";
	echo "<tr><td width='30'><img src='images/spacer.gif' height='1' width='100%'></td>";
	echo "<td colspan='2'><img src='images/break-l.gif' height='1' width='200' vspace='6'></td></tr>";
	
	echo "<tr><td width='30'>&nbsp;</td>";
	echo "<td width='200'>".'Transparancy of the hidden banner'."</td><td width='370'>";
	echo "<select name='transparancy' style='width:60px;'".($hide == '0' ? ' disabled' : '').">";
	for ($i=0;$i<=9;$i++)
	...
	echo "<td width='200'>".$GLOBALS['strHShift']."</td><td width='370'>";
		echo "<input class='flat' type='text' name='offsetx' size='' value='".$offsetx."' style='width:60px;'> ".$GLOBALS['strAbbrPixels']."</td></tr>";
	echo "<tr><td width='30'><img src='images/spacer.gif' height='1' width='100%'></td>";
	echo "<td colspan='2'><img src='images/break-l.gif' height='1' width='200' vspace='6'></td></tr>";
	
	echo "<tr><td width='30'>&nbsp;</td>";
	echo "<td width='200'>".$GLOBALS['strVShift']."</td><td width='370'>";
		echo "<input class='flat' type='text' name='offsety' size='' value='".$offsety."' style='width:60px;'> ".$GLOBALS['strAbbrPixels']."</td></tr>";
	echo "<tr><td width='30'><img src='images/spacer.gif' height='1' width='100%'></td>";
}
