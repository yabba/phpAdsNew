...
$GLOBALS['strUp'] = "Attivo";
$GLOBALS['strDown'] = "Inattivo";
$GLOBALS['strSaved'] = "salvato!";
$GLOBALS['strDeleted'] = "eliminato!";  
$GLOBALS['strMovedUp'] = "attivato";
$GLOBALS['strMovedDown'] = "disattivato";
...
$GLOBALS['strErrorNegViews'] = "Numero di visualizzazioni negative non e' accettato";
...
$GLOBALS['strMailClientDeactivated'] = "Il tuo banner e' stato disattivato perche' ";
$GLOBALS['strMailNothingLeft'] = "Se vuoi continuare ad inserire annunci pubblicitari sul nostro sito puoi contattarci.";
$GLOBALS['strClientDeactivated'] = "Questo cliente non e' attivo perche' ";
$GLOBALS['strBeforeActivate'] = "La data di attivazione non e' stata raggiunta";
$GLOBALS['strAfterExpire'] = "La data di scadenza e' stata raggiunta";
