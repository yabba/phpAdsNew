...
$GLOBALS['strBannerAdminAcl'] = "Administracja ACL bannera dla";
...
$GLOBALS['strModifyBannerAcl'] = "Modyfikuj ACL bannera";
...
$GLOBALS['strACLAdd'] = "Dodaj nowy ".$GLOBALS['strACL'];
$GLOBALS['strACLExist'] = "Istniej±ce ".$GLOBALS['strACL'].":";
