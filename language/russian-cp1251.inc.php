...
$GLOBALS['strMailHeader'] = "Дорогой ".(isset($client["contact"]) ? $client["contact"] : '').",\n";
$GLOBALS['strMailBannerStats'] = "Здесь вы видите статистику клиента ".(isset($client["clientname"]) ? $client["clientname"] : '').":";
