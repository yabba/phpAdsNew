...
$GLOBALS['strDeleteClient'] = "Kunden löschen";
...
$GLOBALS['strAddSep'] = "Bitte entweder die Felder oben oder das Feld unten ausfüllen!";
...
$GLOBALS['strBannerAdmin'] = "Banner Adminstration für";
...
$GLOBALS['strKeyword'] = "Schlüsselwort";
...
$GLOBALS['strClientAdded'] = "Der Benutzer wurde hinzugefügt.";
$GLOBALS['strClientModified'] = "Der Benutzer wurde geändert.";
$GLOBALS['strClientDeleted'] = "Der Benutzer wurde gelöscht.";
$GLOBALS['strBannerAdmin'] = "Banner-Adminstration";
$GLOBALS['strBannerAdded'] = "Das Banner wurde hinzugefügt.";
$GLOBALS['strBannerModified'] = "Das Banner wurde geändert";
$GLOBALS['strBannerDeleted'] = "Das Banner wurde gelöscht";
$GLOBALS['strBannerChanged'] = "Das Banner wurde geändert";
$GLOBALS['strStats'] = "Statistiken";
$GLOBALS['strDailyStats'] = "Tägliche Statistik";
...
$GLOBALS['strUserAgent'] = "RegExp für Browser";
...
$GLOBALS['strResetStats'] = "Statistik zurücksetzen";
...
$GLOBALS['strEstimated'] = "Geschätztes Ablaufdatum";
$GLOBALS['strConfirm'] = "Sind Sie sicher?";
$GLOBALS['strBannerNoStats'] = "Keine Statistikdaten für dieses Banner gespeichert!";
$GLOBALS['strWeek'] = "Kalenderwoche";
$GLOBALS['strWeeklyStats'] = "Wochenübersicht";
...
$GLOBALS['strUp'] = "Vor";
$GLOBALS['strDown'] = "Zurück";
$GLOBALS['strSave'] = "Speichern";
$GLOBALS['strSaved'] = "wurde gespeichert";
$GLOBALS['strDeleted'] = "wurde gelöscht";
$GLOBALS['strMovedUp'] = "wurde vorgesetzt";
$GLOBALS['strMovedDown'] = "wurde zurückgesetzt";
$GLOBALS['strUpdated'] = "wurde geändert";
$GLOBALS['strLogin'] = "Login";
$GLOBALS['strPreferences'] = "Einstellungen";
$GLOBALS['strAllowClientModifyInfo'] = "Kunde darf eigene Daten ändern";
$GLOBALS['strAllowClientModifyBanner'] = "Kunde darf eigene Banner ändern";
$GLOBALS['strAllowClientAddBanner'] = "Kunde darf eigene Banner hinzufügen";
$GLOBALS['strLanguage'] = "Sprache";
$GLOBALS['strDefault'] = "Voreinstellung";
$GLOBALS['strErrorViews'] = "Sie müssen eine Anzahl der AdViews angeben oder die Unbegrenzt-Checkbox aktivieren.";
$GLOBALS['strErrorNegViews'] = "Negative AdViews sind nicht erlaubt.";
$GLOBALS['strErrorClicks'] =  "Sie müssen eine Anzahl der AdClicks angeben oder die Unbegrenzt-Checkbox aktivieren.";
$GLOBALS['strErrorNegClicks'] = "Negative AdClicks sind nicht erlaubt.";
$GLOBALS['strErrorDays'] = "Sie müssen eine Anzahl der AdDays angeben oder die Unbegrenzt-Checkbox aktivieren.";
...
$GLOBALS['strMonth'] = array("Januar", "Februar", "März", "April", "Mai", "Juni", "July", "August", "September", "Oktober", "November", "Dezember");
...
$GLOBALS['strFrameSize'] = "Framegröße";
...
$GLOBALS['strAddZone'] = "Zone hinzufügen";
...
$GLOBALS['strAND'] = "UND";  // logischer Operator
$GLOBALS['strOR'] = "ODER"; // logischer Operator
...
$GLOBALS['strConfirmDeleteCampaign'] = "Möchten Sie diese Kampagne wirklich löschen?";
$GLOBALS['strConfirmDeleteBanner'] = "Möchten Sie dieses Banner wirklich löschen?";
$GLOBALS['strConfirmResetStats'] = "Wollen Sie wirklich alle Statistikdaten zurücksetzen?";
$GLOBALS['strConfirmResetCampaignStats'] = "Wollen Sie wirklich die Statistik diese Kampagne zurücksetzen ?";
$GLOBALS['strConfirmResetClientStats'] = "Wollen Sie wirklich die Statistik dieses Kunden zurücksetzen ?";
$GLOBALS['strConfirmResetBannerStats'] = "Wollen Sie wirklich die Statistik dieses Banners zurücksetzen ?";

$GLOBALS['strClientsAndCampaigns'] = "Kunden &amp; Kampagnen";
$GLOBALS['strCampaignOverview'] = "Kampagnen-Übersicht";
...
$GLOBALS['strRawQueryString'] = "Rohdaten-Abfragestring";

$GLOBALS['strBannerWeight'] = "Bannergewichtung";
$GLOBALS['strCampaignWeight'] = "Kampagnengewichtung";
...
$GLOBALS['strSizeOfCache'] = "Größe des Cache";
