...
$GLOBALS['strAdminstration'] 		= "Bannerbestand";
...
$GLOBALS['strRefresh']				= "Aktualisieren (Refresh)";
$GLOBALS['strSaveChanges']			= "Speicher Änderungen";
$GLOBALS['strUp'] 					= "Oben";
$GLOBALS['strDown'] 				= "Unten";
$GLOBALS['strSave'] 				= "Speichern";
$GLOBALS['strCancel']				= "Abbrechen";
$GLOBALS['strPrevious'] 			= "Vorhergehender";
$GLOBALS['strPrevious_Key'] 		= "<u>V</u>orhergehender";
$GLOBALS['strNext'] 				= "Nächster";
$GLOBALS['strNext_Key'] 			= "<u>N</u>ächster";
$GLOBALS['strYes']					= "Ja";
$GLOBALS['strNo']					= "Nein";
...
$GLOBALS['strFieldFixBeforeContinue2']	= "um diese Fehler zu beheben.";
...
$GLOBALS['strClientProperties']		= "Inserenteneigenschaften";
...
$GLOBALS['strCampaignProperties']		= "Kampagneneigenschaften";
...
$GLOBALS['strBannerProperties']		= "Bannereigenschaften";
...
$GLOBALS['strAffiliateProperties']		= " Verlegereigenschaften"; 
...
$GLOBALS['strZoneProperties']		= "Zoneneigenschaften";
...
$GLOBALS['keyNext']			= 'n'; //nächste
$GLOBALS['keyPrevious']		= 'v'; // vorherige
