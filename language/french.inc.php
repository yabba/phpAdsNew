...
$GLOBALS['strMailHeader'] = "Cher ".$client["contact"].",\n";
$GLOBALS['strMailBannerStats'] = "vous trouverez ci-dessous les statistiques des bandeaux publicitaires pour ".$client["clientname"].":";
