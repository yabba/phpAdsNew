...
$GLOBALS['phpAds_hlp_dbhost'] = "
	Spécifiez l'adresse du serveur de données ".$phpAds_dbmsname." (Ex: sql.monsite.fr).
";
...
$GLOBALS['phpAds_hlp_persistent_connections'] = "
	L'utilisation de connections persistantes peut accélérer considérablement ".$phpAds_productname.", et peut même diminuer
	...
	que vous utilisez. Si ".$phpAds_productname." utilise trop de ressources, vous devriez regarder d'abord cette option.
";
...
$GLOBALS['phpAds_hlp_insert_delayed'] = "
	...
	que ".$phpAds_productname." soit obligé d'attendre avant d'insérer une nouvelle ligne, parce que la table est déjà
...
$GLOBALS['phpAds_hlp_compatibility_mode'] = "
	...
	option est activée, ".$phpAds_productname." devrait laisser l'état de connexion avec la base de données exactement comme
...
$GLOBALS['phpAds_hlp_table_prefix'] = "
	...
	de données, vous devez choisir un préfixe qui est unique à chaque installation de ".$phpAds_productname.".
";
...
$GLOBALS['phpAds_hlp_tabletype'] = "
	...
	toutes les installations ".$phpAds_dbmsname.". Les autres types de tables peuvent ne pas être présents sur votre serveur.
";

$GLOBALS['phpAds_hlp_url_prefix'] = "
	".$phpAds_productname." a besoin de savoir où il est situé sur le serveur, afin de fonctionner correctement.
	Vous devez spécifier l'Url du répertoire dans lequel ".$phpAds_productname." est installé, par exemple:
	http://www.monsite.fr/".$phpAds_productname."
";
...
$GLOBALS['phpAds_hlp_name'] = "
	...
	logo ".$phpAds_productname." sera affiché à la place.
";
...
$GLOBALS['phpAds_hlp_override_gd_imageformat'] = "
	Normalement, ".$phpAds_productname." détecte automatiquement si la librairie GD est installée, et quels formats elle
	supporte. Toutefois, il est possible que la détection ne se fasse pas ou soit faussée, car certaines versions
	de PHP n'autorisent pas la détection des types d'images supportés. Si ".$phpAds_productname." ne parvient pas à détecter
...
$GLOBALS['phpAds_hlp_compact_stats'] = "
	Traditionnellement, ".$phpAds_productname." utilise une journalisation assez intensive, qui est extrêmement détaillée,
	mais qui aussi demande beaucoup au niveau serveur SQL. Cela peut se révéler un gros problème sur des sites
	avec un grand nombre de visiteurs. Pour s'affranchir de ce problème, ".$phpAds_productname." supporte aussi un nouveau type
...
$GLOBALS['phpAds_hlp_block_adviews'] = "
	...
	secondes). Par exemple, si vous mettez cette valeur à 300 secondes, ".$phpAds_productname." ne comptera l'affichage d'une
...
$GLOBALS['phpAds_hlp_reverse_lookup'] = "
	Par défaut, ".$phpAds_productname." journalise l'adresse IP de chaque visiteur. Si vous préférez que ".$phpAds_productname." journalise
...
$GLOBALS['phpAds_hlp_warn_limit'] = "
	La limite en dessous de laquelle ".$phpAds_productname." commence à envoyer les messages d'avertissement. La valeur est
	de 100 par défaut.
";
...
$GLOBALS['phpAds_hlp_acl'] = "
	...
	à chaque affichage, cela accélérera ".$phpAds_productname.".
";

$GLOBALS['phpAds_hlp_default_banner_url'] = 
$GLOBALS['phpAds_hlp_default_banner_target'] = "
	Si ".$phpAds_productname." ne peut pas se connecter au serveur de données, ou ne peut pas trouver une bannière correspondant
...
$GLOBALS['phpAds_hlp_type_html_allow'] = "
	...
	Vous pouvez utilisez l'interface d'administration pour uploader une bannière, et ".$phpAds_productname."
